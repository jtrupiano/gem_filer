...
gemfiler cannot currently be used with rails' "rake test" command.  This is 
due to the fact that this task spawns new threads to run each of your test
suites.  gemfiler can only track those gems activated in a single thread.

gemfiler still needs to be wrapped up into a gem.  I have been considering
